...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1763591487);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1763591487);
user_pref("app.update.lastUpdateTime.region-update-timer", 1763591487);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1763591487);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1763591517);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1763591487);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{97e919dd-f1ed-4084-8055-5e97b7be1911}");
...
user_pref("browser.startup.lastColdStartupCheck", 1763591457);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECInQfkOiIRhrBAgaIldGDxbn6w==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"2e45fc6a-420e-48e5-9d80-f68096e6884d\",\"pictureinpicture@mozilla.org\":\"b726fcbc-f7d7-4e49-89c2-e1972d50e1be\",\"screenshots@mozilla.org\":\"f71aebcd-f1c7-4441-96b2-be48689cf11f\",\"webcompat@mozilla.org\":\"3de9b7b9-f01f-4809-ad7c-12bb7381226c\",\"firefox-compact-dark@mozilla.org\":\"14656f43-ed7d-419f-b2da-771bbf4b2f5d\",\"addons-search-detection@mozilla.com\":\"adeebf0a-6f3c-44cd-9cd3-08e1d13b65ac\",\"uBlock0@raymondhill.net\":\"5a4d5eb0-2909-477f-a557-c2d4b78a070b\"}");
...
user_pref("media.gmp-manager.lastCheck", 1763591525);
user_pref("media.gmp-manager.lastEmptyCheck", 1763591525);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECHQdVAF+YnitBAibDfH641vwtg==");
user_pref("toolkit.startup.last_success", 1763591455);
